...
function normalizeDb(raw = {}) {
  ...
  base.meta = {
    ...
    signalTimeframe: SUPPORTED_SIGNAL_TIMEFRAMES.includes(String(base.meta?.signalTimeframe || "").trim())
      ...
      : SIGNAL_TIMEFRAME,
    shortSwingSettings: normalizeShortSwingSettings(base.meta?.shortSwingSettings, DEFAULT_SHORT_SWING_SETTINGS),
    qualityEmaSettings: normalizeQualityEmaSettings(base.meta?.qualityEmaSettings, DEFAULT_QUALITY_EMA_SETTINGS),
