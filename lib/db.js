...
function sanitizeUser(user) {
  return {
    ...
    bybitSummary: user.bybit
      ? {
          testnet: !!user.bybit.testnet,
          canTrade: !!user.bybit.permissions?.canTrade,
          lastValidatedAt: user.bybit.lastValidatedAt,
          connectedAt: user.bybit.connectedAt,
        }
      : null,
